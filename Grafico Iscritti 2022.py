...
df = pd.read_csv("anagrafica2022.csv")
...
#Con la funzione pd.read_csv() di Pandas, lo indirizzo alla lettura del file csv dove sono contenuti i dai anagrafici degli atleti del 2022
...
#Per finite, stampo il dataframe
